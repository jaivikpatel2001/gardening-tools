 ...
 *
 * Typed to `PhotographedToolCategory`, so a category without a photograph cannot
 * be passed in by mistake. Unphotographed categories still appear in the
 * complete range index.
 */
export function ToolCategoryCard({ category }: { category: PhotographedToolCategory }) {
  return (
    <Link
